...
const {extractCallDir,mergeDeps,isObject,isString} = require('@vite8/utils');
    ...
    render(templateDir){
        ...
        if(isString(templateDir)){
            ...
            this._injectFileMiddleware(async (files,projectOptions)=>{
                const templateFiles = await glob('**/*',{cwd:templateDir,nodir:true});//['routesConfig.js','App.js.ejs']
